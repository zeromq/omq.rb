...
Gem::Specification.new do |s|
  ...
  s.summary  = "Experimental QoS delivery guarantees for OMQ"
  s.description = "Experimental Quality of Service plugin for the OMQ pure-Ruby " \
                  "ZeroMQ library. Adds per-hop delivery guarantees: " \
                  "QoS 1 (at-least-once), QoS 2 " \
